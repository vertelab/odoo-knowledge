...
export class ArticlesStructureBehavior extends AbstractBehavior {
    ...
    async _renderArticlesStructure () {
        ...
        return markup(QWeb.render('knowledge_powerbox_option.articles_structure', {
...
ArticlesStructureBehavior.template = "knowledge_powerbox_option.ArticlesStructureBehavior";
